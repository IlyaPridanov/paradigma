...
(function () {
  ...
  var jsBtnNav = document.querySelector('.hamburger');
  var jsMobile = document.querySelectorAll('.js-mobile');
...
(function () {
  ...
  var inputColumn = document.querySelector('.popup__input-column');
...
(function () {
  ...
  var headerLink = document.querySelector('.header__top-link');
  var mainLink = document.querySelector('.main__link');
